...
namespace Lib
{
    public class TextLogCleaner
    {
        ...
        private Parameter<int> depth_day;
        ...
        public TextLogCleaner(TextLogger logger, Parameter<int> depth_day)
        {
        ...
        private void Handler()
        {
            while (execution)
            {
                ...
                {
                    Message.Make("Error clean log file", ex);
                }
        ...
        private void DeleteFile(DateTime timestamp)
        {
            try
            {
                ...
                File.Delete(file);
                Message.Make($"Deleted file {file}");
            }
            catch (Exception ex)
            {
