...
namespace OPC_DB_gate_server
{
    class RT_values
    {
        ...
        public RT_values()
        {
            ...
            source.Columns.Add(col_name_id, typeof(int)).ExtendedProperties.Add(typeof(Lib.CDatabase.SExtProp),
                                                                                new Lib.CDatabase.SExtProp()
                                                                                {
                                                                                    data_type = System.Data.Odbc.OdbcType.BigInt,
                                                                                    ignore = true
                                                                                });
            source.Columns.Add(col_name_tags_id, typeof(int)).ExtendedProperties.Add(typeof(Lib.CDatabase.SExtProp),
                                                                                     new Lib.CDatabase.SExtProp()
                                                                                     {
                                                                                         data_type = System.Data.Odbc.OdbcType.BigInt,
                                                                                         primary_key = true
                                                                                     });
            source.Columns.Add(col_name_timestamp, typeof(DateTime)).ExtendedProperties.Add(typeof(Lib.CDatabase.SExtProp),
                                                                                     new Lib.CDatabase.SExtProp()
                                                                                     {
                                                                                         data_type = System.Data.Odbc.OdbcType.DateTime,
                                                                                     });
            source.Columns.Add(col_name_value_raw, typeof(byte[])).ExtendedProperties.Add(typeof(Lib.CDatabase.SExtProp),
                                                                                     new Lib.CDatabase.SExtProp()
                                                                                     {
                                                                                         data_type = System.Data.Odbc.OdbcType.Binary,
                                                                                     });
            source.Columns.Add(col_name_value_str, typeof(string)).ExtendedProperties.Add(typeof(Lib.CDatabase.SExtProp),
                                                                                     new Lib.CDatabase.SExtProp()
                                                                                     {
                                                                                         data_type = System.Data.Odbc.OdbcType.VarChar,
                                                                                     });
            source.Columns.Add(col_name_quality, typeof(byte)).ExtendedProperties.Add(typeof(Lib.CDatabase.SExtProp),
                                                                                     new Lib.CDatabase.SExtProp()
                                                                                     {
        ...
        public void Put(LibDBgate.Tag tag)
        {
            try
            {
                ...
                row[col_name_value_raw] = LibDBgate.Tag.ObjToBin(tag.value);
