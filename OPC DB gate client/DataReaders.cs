...
namespace OPC_DB_gate_client
{
    public class DataReaders
    {
        ...
        public DataReaders(TCPconnection connection, Lib.CBuffer<LibDBgate.Tag> buffer)
        {
        ...
        private void Connection_GetTags(Dictionary<int, LibOPCDBgate.TagSettings> value)
        {
            try
            {
